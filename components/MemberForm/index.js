...
function MemberForm({ members, setMembers }) {
  ...
  return (
    ...
    >
      {({ handleChange, handleBlur, values, touched, isInValid, errors }) => {
        return (
          <FormContainer>
            <FormikForm>
              <Row>
                  ...
                  <Form.Group as={Row} controlId="formCitizenId">
                    ...
                    <Col sm="1">
                      <Form.Control
                        ...
                        onBlur={handleBlur}
                        isInvalid={
                          touched.citizenIdBlock1 && errors.citizenIdBlock1
                        }
                      />
                      <Form.Control.Feedback type="invalid">
                    ...
                    <Col>
                      <Form.Control
                        ...
                        onBlur={handleBlur}
                        isInvalid={
                          touched.citizenIdBlock2 && errors.citizenIdBlock2
                        }
                      />
                      <Form.Control.Feedback type="invalid">
                    ...
                    <Col>
                      <Form.Control
                        ...
                        onBlur={handleBlur}
                        isInvalid={
                          touched.citizenIdBlock3 && errors.citizenIdBlock3
                        }
                      />
                      <Form.Control.Feedback type="invalid">
                    ...
                    <Col>
                      <Form.Control
                        ...
                        onBlur={handleBlur}
                        isInvalid={
                          touched.citizenIdBlock4 && errors.citizenIdBlock4
                        }
                      />
                      <Form.Control.Feedback type="invalid">
                    ...
                    <Col sm="1">
                      <Form.Control
                        ...
                        onBlur={handleBlur}
                        isInvalid={
                          touched.citizenIdBlock5 && errors.citizenIdBlock5
                        }
                      />
                      <Form.Control.Feedback type="invalid">
